...
//        String expResultRe = "DocumentScannerConf@[a-z0-9]+["
...
//                + "selectedValueDetectionServiceConfs=[ContactValueDetectionServiceConf@[a-z0-9]+[],"
//                + "[\\s]*TrieCurrencyFormatValueDetectionServiceConf@[a-z0-9]+[],"
//                + "[\\s]*CurrencyFormatValueDetectionServiceConf@[a-z0-9]+[], "
//                + "[\\s]*DateFormatValueDetectionServiceConf@[a-z0-9]+[]],"
//                + "resolutionWish=200,"
...
//                + "autoOCRValueDetectionFormatterMap={class java.util.Date=DateOCRResultFormatter@[a-z0-9]+},"
