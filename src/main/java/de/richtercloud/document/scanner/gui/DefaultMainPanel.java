...
import de.richtercloud.document.scanner.components.MainPanelScanResultPanelFetcher;
import de.richtercloud.document.scanner.components.OCRResultPanelFetcher;
import de.richtercloud.document.scanner.components.OCRResultPanelFetcherProgressEvent;
...
import de.richtercloud.document.scanner.flexdock.MainPanelDockingManagerFlexdock;
...
import de.richtercloud.document.scanner.ifaces.OCRSelectPanelPanelFetcherProgressEvent;
import de.richtercloud.document.scanner.ifaces.OCRSelectPanelPanelFetcherProgressListener;
    ...
    private Pair<OCRSelectComponent, EntityPanel> addDocumentRoutine(List<ImageWrapper> images,
        ...
        try {
            ...
            OCRPanel oCRPanel = new DefaultOCRPanel(entityClasses0,
                    ...
                    fieldRetriever,
                    documentScannerConf);
            EntityPanel entityPanel = new DefaultEntityPanel(amountMoneyCurrencyStorage,
                    amountMoneyExchangeRateRetriever,
                    reflectionFormBuilder,
                    fieldHandler,
                    issueHandler,
