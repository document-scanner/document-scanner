...
public abstract class Identifiable implements Serializable {
    ...
    */
    ...
    /*
    internal implementation notes:
    - List<String> fails in OpenJPA due to `org.apache.openjpa.util.InternalException: Unexpected attribute type "String" for persistence-capable class "FinanceAccount" is detected.`
...
Exception Description: The type [class java.sql.Timestamp] for the attribute [lastUsed] on the entity class [class Identifiable] is not a valid type for a temporal mapping. The attribute must be defined as java.util.Date or java.util.Calendar.`
